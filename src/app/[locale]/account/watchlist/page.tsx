...
export default function Page() {
  return (
    <div className="container mx-auto px-4 py-12">
      ...
      <h1 className="text-3xl font-bold mb-4 capitalize">watchlist</h1>
      <div className="bg-card border border-border rounded-xl p-8 text-center">
        <p className="text-muted-foreground">This page will display your watchlist when connected to Supabase Auth.</p>
